# ESTE CÓDIGO FOI NECESSÁRIO DEVIDO À GRANDE QUANTIDADE DE DADOS NUM SÓ .CSV. 
# DIVIDINDO O FICHEIRO, É DIVIDIDO TAMBÉM O TEMPO DE EXECUÇÃO DE EXTRAÇÃO DOS DADOS
